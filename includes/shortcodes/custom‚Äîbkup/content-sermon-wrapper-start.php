...
switch ( $template ) {
	...
	case 'twentyseventeen':
		...
		break;
	case 'Divi':
		echo '<div id="main-content"><div class="divi-container-sermon"><div id="content-area" class="clearfix"><main id="area" class="wpfc-sermon-container wpfc-divi">';
		break;
	case 'salient':
		...
		break;
	case 'Avada':
		echo '<div class="wpfc-sermon-container wpfc-avada wpfc-sermon-before smpro-avada-main">';
		break;
	case 'wpfc-morgan':
